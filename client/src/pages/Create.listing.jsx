        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
               ...
               <div className='flex flex-wrap gap-6 '>
                ...
                <div className='flex items-center gap-2'>
                    <input type='number' id="regularPrice" min="50" max="1000000" required className='p-3 border border-grey-300 rounded-lg' 
                    onChange={handleChange}
                ...
                {formData.offer && (
                    <div className='flex items-center gap-2'>
                    <input type='number' id="discountPrice" min="0" max="1000000" required className='p-3 border border-grey-300 rounded-lg' 
                    onChange={handleChange}
               ...
               '>{loading ? 'Creating...' : 'Creat listing'}</button>
